...
public class PhysicsSolver {
    ...
    public static class Slot {
        ...
        public boolean setValue(double value) {
            ...
            else if (areSameDoubles(value,this.value)){
                return false;
            }
            else {
                throw new RuntimeException("no bro");
            }
    ...
    public static class Multiplication extends Relation {
         ...
         * This method tries to derive the value of unknown variables
         * in the relation, given the values of the known variables.
         * @return <code>true</code> if at least one slot has been
         * updated.
         **/
        @Override
        public boolean update() {
            if (factor1_.hasValue() && factor2_.hasValue() && product_.hasValue()){
                ...
                return product_.setValue(factor1_.value*factor2_.value);
            }
            else if (factor1_.hasValue() && product_.hasValue()){
                return factor2_.setValue(product_.value/factor1_.value);
            }
            else if (factor2_.hasValue() && product_.hasValue()){
                return factor1_.setValue(product_.value/factor2_.value);
            }
            else {
                return false;
            }
    ...
    public static class Squaring extends Relation {
        ...
        public boolean update() {
            if (number_.hasValue() && square_.hasValue() ){
                ...
                return square_.setValue(Math.pow(number_.value, 2));
            }
            else if (square_.hasValue() ){
                return number_.setValue(Math.pow(square_.value, 0.5));
            }
